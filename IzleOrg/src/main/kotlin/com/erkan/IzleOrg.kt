...
class DiziPal : MainAPI() {
    override var mainUrl              = "https://izleorg4.org"
    override var name                 = "İzleOrg"
    ...
    override val mainPage = mainPageOf(
        "${mainUrl}/aile-filmleri"                               to "Aile Filmleri",
        "${mainUrl}/aksiyon-filmleri"                                       to "Aksiyon Fİlmleri",
        "${mainUrl}/animasyon-filmleri"                                       to "Animasyon",
        "${mainUrl}/belgesel-filmleri"                            to "Belgesel",
        "${mainUrl}/bilimkurgu-filmleri"                              to "Bilimkurgu",
        "${mainUrl}/biyografi-filmleri"                              to "Biyografi",
        "${mainUrl}/dram-filmleri"                                   to "Dram Filmleri",
        "${mainUrl}/gerilim-filmleri"                                to "Gerilim",
        "${mainUrl}/gizem-filmleri"                                 to "Gizem",
        "${mainUrl}/komedi-filmleri"                               to "Komedi",
        "${mainUrl}/korku-filmleri"                                      to "Korku Filmleri",
        "${mainUrl}/macera-filmleri"                                      to "Macera Filmleri",
        "${mainUrl}/romantik-filmleri"                                      to "Romantik Filmleri",
        "${mainUrl}/savas-filmleri"                                      to "Savaş Filmleri",
        "${mainUrl}/suc-filmleri"                                      to "Suç Filmleri",
        "${mainUrl}/tarih-filmleri"                                      to "Tarih Filmleri",
